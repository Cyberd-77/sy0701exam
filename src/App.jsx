...
import questionsPool from './questionsData'; // Import questions from a separate file
...
const QuizApp = () => {
  ...
  const renderQuestion = () => {
    ...
    return (
      <div className="flex flex-col flex-grow p-4 md:p-8 bg-gray-800 rounded-lg shadow-2xl space-y-6 overflow-y-auto max-h-[80vh] mx-auto w-full max-w-4xl">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-4 pb-4 border-b border-gray-700">
          <div className="mb-4 md:mb-0">
            <span className="text-xl font-bold text-blue-400">
              Question {currentQuestionIndex + 1} of {currentQuestions.length}
            </span>
            <span className="block text-sm text-gray-400 font-mono mt-1">Domain: {question.domain}</span>
          </div>
        ...
        <div className="space-y-4 flex-grow">
          {question.options.map((option, index) => {
            ...
            let className = `p-4 rounded-lg cursor-pointer transition-colors duration-200 text-gray-200 font-medium border-2 ${
              isSelected ? 'border-blue-500 bg-blue-900' : 'border-gray-700 hover:border-blue-500'
            }`;
            ...
            if (showResults) {
              ...
              if (isCorrectOption) {
                ...
                className = 'p-4 rounded-lg text-gray-400 font-medium border-2 border-gray-700';
              }
            }
    ...
    <div className="min-h-screen bg-gray-900 text-white p-4 sm:p-8 flex flex-col items-center">
      <div className="w-full max-w-7xl flex flex-col md:flex-row gap-8">
        ...
        <div className="flex flex-col flex-grow w-full md:w-3/4">
          <div className="bg-gray-800 p-4 rounded-lg shadow-lg mb-6 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
          ...
          <div className="flex justify-between items-center mt-6 p-4 bg-gray-800 rounded-lg shadow-lg">
            <button
              ...
              className="bg-blue-600 disabled:bg-gray-700 disabled:text-gray-500 disabled:cursor-not-allowed hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg text-lg transition-colors duration-200 flex items-center space-x-2"
            >
              <ArrowLeft size={20} />
              <span>Previous</span>
            </button>
        ...
        {!isMobile && (
          <div className="w-full md:w-1/4">
            <div className="bg-gray-800 p-4 rounded-lg shadow-lg max-h-[80vh] overflow-y-auto">
              ...
              <div className="grid grid-cols-5 gap-2">
                {currentQuestions.map((_, index) => {
                  ...
                  if (isCurrent) {
                    ...
                    btnClass += ' bg-gray-600 text-gray-300 hover:bg-gray-700';
                  }
