 ...
 * @property {string} correctAnswer - The correct answer string.
...
const questions = [
  ...
  },
  {
    ...
    correctAnswer: "System disruption",
    domain: "1.0 Attacks, Threats, and Vulnerabilities",
    difficulty: "Easy",
  ...
  },
  {
    ...
    correctAnswer: "Urgency/Intimidation",
    domain: "1.0 Attacks, Threats, and Vulnerabilities",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "Cracking password hashes",
    domain: "1.0 Attacks, Threats, and Vulnerabilities",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "To isolate public-facing servers from the internal network",
    domain: "2.0 Architecture and Design",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "Granting users only the minimum permissions necessary to perform their job functions",
    domain: "2.0 Architecture and Design",
    difficulty: "Easy",
  ...
  },
  {
    ...
    correctAnswer: "To collect, analyze, and correlate security event data from various sources",
    domain: "2.0 Architecture and Design",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "Security is integrated into every phase of development",
    domain: "2.0 Architecture and Design",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "To perform cryptographic operations and store cryptographic keys securely",
    domain: "2.0 Architecture and Design",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "It generates and securely stores strong, unique passwords",
    domain: "3.0 Implementation",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "Using WPA3 encryption with strong passwords",
    domain: "3.0 Implementation",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "To manage and apply software updates and security patches",
    domain: "3.0 Implementation",
    difficulty: "Easy",
  ...
  },
  {
    ...
    correctAnswer: "To prevent DNS spoofing and cache poisoning attacks",
    domain: "3.0 Implementation",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "To verify the identity of a user or website and establish trust",
    domain: "3.0 Implementation",
    difficulty: "Easy",
  ...
  },
  {
    ...
    correctAnswer: "To identify the root cause of an incident and gather evidence",
    domain: "4.0 Operations and Incident Response",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "A fully equipped alternative facility that can be operational almost immediately",
    domain: "4.0 Operations and Incident Response",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "Mean Time To Recovery (MTTR)",
    domain: "4.0 Operations and Incident Response",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "To ensure that critical business functions can continue during and after a disaster",
    domain: "4.0 Operations and Incident Response",
    difficulty: "Easy",
  ...
  },
  {
    ...
    correctAnswer: "A chronological documentation of evidence handling to maintain its integrity",
    domain: "4.0 Operations and Incident Response",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "Eradication and Recovery",
    domain: "4.0 Operations and Incident Response",
    difficulty: "Easy",
  ...
  // --- Domain 5.0: Governance, Risk, and Compliance ---
  {
    ...
    correctAnswer: "To outline the expected level of service and responsibilities between a provider and a customer",
    domain: "5.0 Governance, Risk, and Compliance",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "Assigning monetary values to assets and potential losses",
    domain: "5.0 Governance, Risk, and Compliance",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "To make employees aware of security risks and their role in protecting organizational assets",
    domain: "5.0 Governance, Risk, and Compliance",
    difficulty: "Easy",
  ...
  },
  {
    ...
    correctAnswer: "To document identified risks, their potential impact, likelihood, and mitigation strategies",
    domain: "5.0 Governance, Risk, and Compliance",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "Collecting only the data that is necessary for a specific purpose",
    domain: "5.0 Governance, Risk, and Compliance",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "To advise on data protection compliance and oversee related activities",
    domain: "5.0 Governance, Risk, and Compliance",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "NIST Cybersecurity Framework (CSF)",
    domain: "5.0 Governance, Risk, and Compliance",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "To identify and mitigate privacy risks associated with a new project or system",
    domain: "5.0 Governance, Risk, and Compliance",
    difficulty: "Hard",
  ...
  // Adding more questions to reach a substantial pool
  {
    ...
    correctAnswer: "An attack where attackers use stolen credentials from one service to try and log into other services",
    domain: "1.0 Attacks, Threats, and Vulnerabilities",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "To detect vulnerabilities by feeding invalid, unexpected, or random data to a computer program",
    domain: "1.0 Attacks, Threats, and Vulnerabilities",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "Grammatical errors and urgent requests",
    domain: "1.0 Attacks, Threats, and Vulnerabilities",
    difficulty: "Easy",
  ...
  },
  {
    ...
    correctAnswer: "Malicious code intentionally inserted into a software system that will set off a malicious function when specified conditions are met",
    domain: "1.0 Attacks, Threats, and Vulnerabilities",
    difficulty: "Medium",
...

  {
    ...
    correctAnswer: "It allows for isolation of virtual machines, limiting the impact of a compromise on one VM",
    domain: "2.0 Architecture and Design",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "It allows for smaller, isolated components, limiting the attack surface and impact of a breach",
    domain: "2.0 Architecture and Design",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "Cloud Access Security Broker (CASB)",
    domain: "2.0 Architecture and Design",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "A system that fails to a secure state, denying access rather than allowing unauthorized access",
    domain: "2.0 Architecture and Design",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "To make rainbow table attacks more difficult by adding unique data to each password before hashing",
    domain: "3.0 Implementation",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "Wildcard certificate",
    domain: "3.0 Implementation",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "To authenticate and authorize devices attempting to connect to a network",
    domain: "3.0 Implementation",
    difficulty: "Medium",
...

  {
    ...
    correctAnswer: "To identify what went well, what went wrong, and how to improve future incident response",
    domain: "4.0 Operations and Incident Response",
    difficulty: "Easy",
  ...
  },
  {
    ...
    correctAnswer: "To simulate an incident in a discussion-based format to test plans and procedures",
    domain: "4.0 Operations and Incident Response",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "Security monitoring",
    domain: "4.0 Operations and Incident Response",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "To revert a system or application to a previous stable state in case of issues with a new deployment or change",
    domain: "4.0 Operations and Incident Response",
    difficulty: "Easy",
...

  {
    ...
    correctAnswer: "To take reasonable steps to protect an organization's assets and comply with regulations",
    domain: "5.0 Governance, Risk, and Compliance",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "Policies are high-level statements, standards provide specific, mandatory requirements",
    domain: "5.0 Governance, Risk, and Compliance",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "Assigning risk levels like 'High', 'Medium', 'Low'",
    domain: "5.0 Governance, Risk, and Compliance",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "To define how long specific types of data should be kept and how they should be disposed of",
    domain: "5.0 Governance, Risk, and Compliance",
    difficulty: "Easy",
  ...
  },
  {
    ...
    correctAnswer: "An attack where a hacker infects a website frequently visited by a target group",
    domain: "1.0 Attacks, Threats, and Vulnerabilities",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "Security auditing",
    domain: "1.0 Attacks, Threats, and Vulnerabilities",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "Registering domain names that are common misspellings of legitimate websites to trick users",
    domain: "1.0 Attacks, Threats, and Vulnerabilities",
    difficulty: "Easy",
  ...
  },
  {
    ...
    correctAnswer: "Ensuring that no single individual has complete control over a critical process or system",
    domain: "2.0 Architecture and Design",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "It introduces unmanaged and potentially insecure systems and applications into the enterprise environment",
    domain: "2.0 Architecture and Design",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "To provide an isolated environment for running untrusted code or testing applications without affecting the main system",
    domain: "2.0 Architecture and Design",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "To isolate guest devices from the main internal network for security",
    domain: "3.0 Implementation",
    difficulty: "Easy",
  ...
  },
  {
    ...
    correctAnswer: "It adds multiple layers of security by requiring more than one verification method",
    domain: "3.0 Implementation",
    difficulty: "Easy",
  ...
  },
  {
    ...
    correctAnswer: "Stateful firewall",
    domain: "3.0 Implementation",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "A basic facility with infrastructure but no equipment or data, requiring significant setup time",
    domain: "4.0 Operations and Incident Response",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "Ensuring evidence has not been altered or tampered with since its collection",
    domain: "4.0 Operations and Incident Response",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "The maximum tolerable amount of data loss measured in time",
    domain: "4.0 Operations and Incident Response",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "To continuously monitor, detect, analyze, and respond to cybersecurity incidents",
    domain: "4.0 Operations and Incident Response",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "To outline the proper and improper ways employees can use organizational IT resources",
    domain: "5.0 Governance, Risk, and Compliance",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "Acting responsibly and prudently to protect information assets",
    domain: "5.0 Governance, Risk, and Compliance",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "Purchasing cybersecurity insurance",
    domain: "5.0 Governance, Risk, and Compliance",
    difficulty: "Easy",
  ...
  },
  {
    ...
    correctAnswer: "It changes its code to avoid detection by antivirus software",
    domain: "1.0 Attacks, Threats, and Vulnerabilities",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "Phishing conducted via SMS text messages",
    domain: "1.0 Attacks, Threats, and Vulnerabilities",
    difficulty: "Easy",
  ...
  },
  {
    ...
    correctAnswer: "To establish a minimum level of security for systems and applications",
    domain: "2.0 Architecture and Design",
    difficulty: "Easy",
  ...
  },
  {
    ...
    correctAnswer: "The cloud service provider",
    domain: "2.0 Architecture and Design",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "To prevent any changes to deployed systems, requiring new deployments for updates",
    domain: "2.0 Architecture and Design",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "To provide hardware-based security functions, including cryptographic operations and secure storage of keys",
    domain: "3.0 Implementation",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "Allowing users to authenticate once and gain access to multiple independent systems or applications across different organizations",
    domain: "3.0 Implementation",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "To protect web applications from common web-based attacks like SQL injection and XSS",
    domain: "3.0 Implementation",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "The process of identifying, collecting, and producing electronically stored information (ESI) for legal purposes",
    domain: "4.0 Operations and Incident Response",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "Threat Hunting Team",
    domain: "4.0 Operations and Incident Response",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "To reduce a system's attack surface by configuring it securely, removing unnecessary services, and applying patches",
    domain: "4.0 Operations and Incident Response",
    difficulty: "Easy",
  ...
  },
  {
    ...
    correctAnswer: "To identify critical business functions and the impact of their disruption",
    domain: "4.0 Operations and Incident Response",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "To outline an agreement between two or more parties that is not legally binding but signifies a common intent",
    domain: "5.0 Governance, Risk, and Compliance",
    difficulty: "Medium",
  ...
  },
  {
    ...
    correctAnswer: "A hierarchical structure of policies, standards, guidelines, and procedures",
    domain: "5.0 Governance, Risk, and Compliance",
    difficulty: "Hard",
  ...
  },
  {
    ...
    correctAnswer: "A threat is a potential danger, a vulnerability is a weakness that can be exploited",
    domain: "5.0 Governance, Risk, and Compliance",
    difficulty: "Easy",
